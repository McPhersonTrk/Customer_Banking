# Customer_Banking Project

## Overview

During the course of this project, I encountered several synchronization errors between OneDrive and GitHub. To resolve this issue, I reorganized the directory in Explorer, which successfully addressed synchronization problems related to Git pull, push, and commit operations.

## Code Issues

1. Identified missing valuation and incomplete user/owner input in CD and savings account Python files.
2. Sought assistance through TA office hours to effectively address and rectify the identified issues.

## Learning and Improvement

- Engaged in the W3Schools Python course to enhance proficiency in Python programming.
- Iterated through the assignment multiple times, refining and improving the code with each iteration.
...
Acknowledging the need for more practice in syntax and committing to avoiding "_____ can't be accessed" errors in future coding endeavors.
